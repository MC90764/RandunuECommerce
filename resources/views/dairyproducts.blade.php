...
<head>
    ...
    <title>Dairy Products|Randunu Super Center</title>
...
<section class="grocery" id="grocery">
    <div class="swiper product-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class=" box">
                <img src="./image/Dairy House Stawberry Set Yoghurt 80G.jpeg" alt="">
                <h3>Dairy House Stawberry Set Yoghurt 80G</h3>
                <div class="price"> Rs 110.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Kotmale Salted Butter 200G.jpeg" alt="">
                <h3>Kotmale Salted Butter 200G</h3>
                <div class="price">Rs.700.00</div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Highland Salted Butter 200G.jpeg" alt="">
                <h3>Highland Salted Butter 200G</h3>
                <div class="price">Rs 700.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>
