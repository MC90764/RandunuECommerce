...
<head>
    ...
    <title>Personal Care|Randunu Super Center</title>
...
<h1 class="heading"> <span>Personal Care</span> </h1>
<nav class="navbar">  
    <div class="btn-group">
...
<section class="grocery" id="grocery">
    <div class="swiper product-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class=" box">
                <img src="./image/
Head & Shoulder Shampoo Anti Hair Fall 720Ml.jpeg" alt="">
                <h3>
Head & Shoulder Shampoo Anti Hair Fall 720Ml</h3>
                <div class="price"> Rs 3,740.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Chandanalepa Face Scrub Herbal 40G.jpeg" alt="">
                <h3>Chandanalepa Face Scrub Herbal 40G</h3>
                <div class="price">Rs 370.00</div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/4Ever Face Wash Lunuwila 100Ml.jpeg" alt="">
                <h3>4Ever Face Wash Lunuwila 100Ml</h3>
                <div class="price">Rs 360.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Viana Mild Face Scrub Jojoba Oil And Vitamin E 100Ml.jpeg" alt="">
                <h3>Viana Mild Face Scrub Jojoba Oil And Vitamin E 100Ml</h3>
