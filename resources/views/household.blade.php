...
<head>
    ...
    <title>Household|Randunu Super Center</title>
...
<h1 class="heading"> <span>Household</span> </h1>
<nav class="navbar">  
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
          ...
          <br>
          <li><a class="dropdown-item" href="{{url('/dairy-products')}}">Dairy Products</a></li>
          <br>
          <li><a class="dropdown-item" href="{{url('/frozen')}}">Frozen</a></li>
          <br>
          <li><a class="dropdown-item" href="{{url('/personalcare')}}">Personal Care</a></li>
          <br>
          <li><a class="dropdown-item" href="{{url('/baby-care')}}">Baby Care</a></li>
          <br>
        </ul>
      </div>
...
<section class="grocery" id="grocery">
    <div class="swiper product-slider">
        <div class="swiper-wrapper">
            ...
            <div class=" box">
                <img src="./image/Vim Dishwash Bar 200G.jpeg" alt="">
            ...
            <div class=" box">
                <img src="./image/Dash Gliz Dish Wash Lime 500ml.jpeg" alt="">
                <h3>Dash Gliz Dish Wash Lime 500ml</h3>
                <div class="price">Rs 490.00</div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Vim Dishwash Liquid Anti Bacterial 500Ml.jpeg" alt="">
                <h3>Vim Dishwash Liquid Anti Bacterial 500Ml</h3>
                <div class="price">Rs 535.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Bio Clean Toilet Bowl Cleaner Floral 500Ml.jpeg" alt="">
                <h3>Bio Clean Toilet Bowl Cleaner Floral 500Ml</h3>
