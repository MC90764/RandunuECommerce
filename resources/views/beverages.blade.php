...
<head>
    ...
    <title>Beverages|Randunu Super Center</title>
...
<section class="grocery" id="grocery">
    <div class="swiper product-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class=" box">
                <img src="./image/Pepsi 2L.jpeg" alt="">
                <h3>Pepsi 2L</h3>
                <div class="price"> Rs 420.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Fanta Cream Soda Pet 1050Ml.jpeg" alt="">
                <h3>Fanta Cream Soda Pet 1050Ml/h3>
                <div class="price">Rs 250.00</div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Elephant House Carbonated Soft Drink Necto 1.5L.jpeg" alt="">
                <h3>Elephant House Carbonated Soft Drink Necto 1.5L</h3>
                <div class="price">Rs 350.00 </div>
                <a href="#" class="btn">add to cart</a>
            </div>

            <div class=" box">
                <img src="./image/Elephant House Carbonated Soft Drink Soda 1L.jpeg" alt="">
                <h3>Elephant House Carbonated Soft Drink Soda 1L</h3>
