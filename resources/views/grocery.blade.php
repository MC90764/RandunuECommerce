...
<head>
    ...
    <title>Grocery|Randunu Super Center</title>
...
<h1 class="heading"> <span>Grocery Products</span> </h1>
<nav class="navbar">
    <div class="btn-group">
        ...
        <div class="swiper-wrapper">
            @foreach ($products as $key=>$product)
               ...
               <div class="box">
                    ...
                    <div><img src="{{ url('') }}/public/image/{{$product->image}}"" height="100px" width="200px"/></div>
                        <h3>{{ $product->productName }}</h3>
                            <h4><span style="color:rgb(255, 0, 0)">Product Category:</span>{{ $product->productCategory }}</h4>
                            <h5>{{ $product->desc }}</h5>
                            <h3>{{ $product->price }}</h3>
